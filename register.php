...
?>
    ...
    <!-- registration area -->
    <section id="register" style=" padding: 5% 0;
    background: url('assets/1678014.png') no-repeat;
    background-size: cover;">
        <div class="row m-0">
            <div class="col-lg-4 offset-lg-2">
                <div class="text-center pb-5">
                    <h1 class="login-title " style="color:white">Register</h1>
                    <p class="p-1 m-0 font-ubuntu " style="color:white " >Register and enjoy additional features</p>
                    <span class="font-ubuntu" style="color:white">I already have <a href="login.php" style="color:yellow">Login</a></span>
                </div>
                <div class="upload-profile-image d-flex justify-content-center pb-5">
                    <div class="text-center">
                        ...
                        <img src="./assets/profile/male_avatar-512.png" style="width: 200px; height: 200px" class="img rounded-circle" alt="profile">
                ...
                <div class="d-flex justify-content-center">
                    <form action="register.php" method="post" enctype="multipart/form-data" id="reg-form">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            <label for="agreement" class="form-check-label font-ubuntu" style="color:white">I agree <a href="#" style="color:yellow">term, conditions, and policy </a>(*) </label>
                        </div>
