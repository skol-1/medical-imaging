...
<!-- registration area -->
<section id="login-form" style=" padding: 5% 0;
    background: url('assets/1295663.jpg') no-repeat;
        ...
        <div class="col-lg-4 offset-lg-2">
            ...
            <div class="upload-profile-image d-flex justify-content-center pb-5">
                <div class="text-center">
                    <img src="<?php echo isset($user['profileImage']) ? $user['profileImage'] : './assets/profile/male_avatar-512.png' ; ?>" style="width: 200px; height: 200px" class="img rounded-circle" alt="profile">
                </div>
            </div>
